const Toggle = ({ isChecked, setChecked }) => {
	return (
		<label className="flex items-center relative w-max cursor-pointer select-none mb-5">
			...
			<input
			className="peer appearance-none transition-colors cursor-pointer w-14 h-7 rounded-full bg-danger-dark checked:bg-success-main ring-[3px] ring-secondary-main"
			type="checkbox"
