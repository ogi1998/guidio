			...
			{activeUser ?
				(
					<div className="flex w-full justify-end gap-5 items-center text-light-main relative">
						...
						<button onClick={logoutHandler} className="bg-success-main py-3 px-5 rounded-md text-lg font-medium hover:bg-success-dark">
							LOGOUT
						</button>
					</div>
				) : (
					<div className="flex w-full justify-end gap-5 items-center text-light-main">
						<NavLink to="/auth/register" className="bg-secondary-main py-[0.6rem] px-5 rounded-md text-lg font-medium hover:bg-secondary-dark">
							REGISTER
						</NavLink>
						<NavLink to="/auth/login" className="bg-success-main py-[0.6rem] px-5 rounded-md text-lg font-medium hover:bg-success-dark">
							LOGIN
						</NavLink>
					</div>
				)}
